export type GameConfig = {
  ...
  round: { durationMs: number; startCountdownMs: number }; // 15 minutes in milliseconds
...
export const CONFIG: GameConfig = {
  ...
  weapons: {
    ...
    projectile: {
      ...
      railgun: { speed: 860, ttl: 1400, pierce: 6, width: 3 },
      flamethrower: { speed: 180, ttl: 280, cone: 0.65, shards: 5, burnMs: 1500, burnDps: 18 },
    },
    ammo: {
      initial: { pistol: 60, smg: 120, shotgun: 24, railgun: 12, flamethrower: 180 },
      pickupGain: { pistol: 15, smg: 30, shotgun: 6, railgun: 12, flamethrower: 45 },
      max: { pistol: 120, smg: 240, shotgun: 48, railgun: 128, flamethrower: 360 },
    },
  },
